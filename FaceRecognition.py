...
from utils.general import (LOGGER, Profile, check_file, check_img_size, check_imshow, check_requirements, cv2,
...
if __name__ == '__main__':
    ...
    if hasattr(opt, 'source') and opt.source == '0' and opt.view_img:
